...
- [**C99**](https://skeleton-tracing.netlify.app/c) (parallelized with pthreads, libpng for reading and X11 for display)
- [**C++**](https://skeleton-tracing.netlify.app/cpp) (thinly wrapped from C version)
- [**JavaScript**](https://skeleton-tracing.netlify.app/wasm) (WebAssembly compiled from C++ using emscripten)
- [**Vanilla JS**](https://skeleton-tracing.netlify.app/js) (Pure JavaScript implementation)
- [**Pure Python**](https://skeleton-tracing.netlify.app/py) (slow)
- [**Python using C API**](https://skeleton-tracing.netlify.app/swig) (compiled from C using SWIG, compatible with numpy and opencv)
- [**Java**](https://skeleton-tracing.netlify.app/java) (includes a Processing demo)
- [**OpenFrameworks addon**](https://skeleton-tracing.netlify.app/of) (friendly wrapper on C++ version)
- [**C#**](https://skeleton-tracing.netlify.app/cs) (demo script for Unity Engine)
- [**Go**](https://skeleton-tracing.netlify.app/go) (parallelized with goroutines)
- [**Swift**](https://skeleton-tracing.netlify.app/swift) (demo with NSImage and AppKit)
- [**Rust**](https://skeleton-tracing.netlify.app/rs) (simple rust implementation)
- [**Julia**](https://skeleton-tracing.netlify.app/jl) (julia implementation with array views)
