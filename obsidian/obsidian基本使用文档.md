...
![仓库切换示意图1](image/仓库名.png)
![仓库切换示意图2](image/仓库名下拉列表.png)

---

#### 基本操作
##### 左侧面板基本操作
 ![关于左侧面板的基本操作](image/关于左侧面板的基本操作.png)
 以上五个控件分别为：
 1. 收起 | 展开 左侧面板
 2. 文件列表：文件树，显示所有的文件
 3. 搜索：在库中全局搜索文件内容。
...
---
##### 右侧面板基本操作
![关于右侧面板的基本操作](image/关于右侧面板的基本操作.png)
以上四个控件分别为：
1. 收起 | 展开右侧面板
2. **反向链接**：
   - 显示所有引用当前文档的位置
...
---
##### 文件列表面板基本操作
![关于文件树的基本操作控件](image/关于文件树的基本操作控件.png)
以上五个控件分别为：
1. 新建笔记：
	- 新增一个Markdown文件
...
##### 左侧快捷菜单基本操作
![关于左侧快捷菜单的基本操作](image/关于左侧快捷菜单的基本操作.png)
以上6个控件分别为：
1. 打开快速切换
	- 默认快捷键：`Ctrl + O`
